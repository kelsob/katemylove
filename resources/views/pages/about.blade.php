        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-spaceTeal-5 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-spaceWhite-1">
                    <h1 class="text-4xl font-bold mb-4 text-spaceOrange-1 font-space-crusaders">About Kate Howells</h1>
                    ...
                    <section class="mb-12">
                        <h2 class="text-2xl font-bold mb-4 text-spaceTeal-2 font-space-crusaders">Background</h2>
                    ...
                    <section class="mb-12">
                        <h2 class="text-2xl font-bold mb-4 text-spaceTeal-2 font-space-crusaders">Experience</h2>
                        <div class="bg-spaceTeal-4 p-6 rounded-lg shadow-md">
                    ...
                    <section>
                        <h2 class="text-2xl font-bold mb-4 text-spaceTeal-2 font-space-crusaders">Mission</h2>
                        <div class="bg-spaceTeal-4 p-6 rounded-lg shadow-md">
