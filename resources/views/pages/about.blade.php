        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <section class="mb-12">
                        <h2 class="text-2xl font-bold mb-4 text-spaceCerulean-600">Background</h2>
                    ...
                    <section class="mb-12">
                        <h2 class="text-2xl font-bold mb-4 text-spaceCerulean-600">Experience</h2>
                    ...
                    <section>
                        <h2 class="text-2xl font-bold mb-4 text-spaceCerulean-600">Mission</h2>
